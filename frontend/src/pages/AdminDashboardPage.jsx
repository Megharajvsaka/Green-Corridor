...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="flex w-screen bg-gray-900 text-white h-screen overflow-hidden">
      {!hospitalsLoaded && (
        <div className="absolute inset-0 bg-gray-900 flex items-center justify-center z-50 flex-col gap-4">
          <div className="rounded-full h-14 w-14 border-4 border-green-400 border-t-transparent animate-spin" />
